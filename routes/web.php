...
Route::post('/addBooks', 'BooksController@store')->name('add.book.store');

Route::get('/categoriesList','BooksCategoryController@index');
Route::get('/addCategories', 'BooksCategoryController@create');
Route::post('/addCategories', 'BooksCategoryController@store')->name('add.category.store');


Route::get('/issuedBooks','BooksIssuedController@index');
Route::post('/issueBooks', 'BooksIssuedController@store')->name('add.issueBooks.store');
...
Route::post('/addMembers', 'MemberController@store')->name('add.addMembers.store');
